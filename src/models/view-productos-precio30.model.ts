...
@model({
  settings: {idInjection: false, mssql: {schema: 'dbo', table: 'viewProductosPrecio30'}}
})
export class ViewProductosPrecio30 extends Entity {
  @property({
    type: 'string',
    length: 255,
  ...
  constructor(data?: Partial<ViewProductosPrecio30>) {
    super(data);
  }
}

export interface ViewProductosPrecio30Relations {
  // describe navigational properties here
}

export type ViewProductosPrecio30WithRelations = ViewProductosPrecio30 & ViewProductosPrecio30Relations;
